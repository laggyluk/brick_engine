...
type
  ...
  public
    ...
    procedure RegisterFunction(FuncName: AnsiString; MethName: AnsiString = ''; Obj: TObject = NIL); virtual; //register function
...
//
function LuaCallBack(L: pLua_State): Integer; cdecl;
var
...
//
procedure TLua.RegisterFunction(FuncName: AnsiString; MethName: AnsiString = ''; Obj: TObject = NIL);
var
...
begin
  ...
  CallBack.Routine.Code := Obj.MethodAddress(String(MethName));
